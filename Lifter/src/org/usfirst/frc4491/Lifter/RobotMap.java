...
public class RobotMap {
    // To calibrate the encoder, we will turn on the motor
    // in one direction for this number of encoder rotation.
    // This must be adjust to the reality of the lift!
    final static double m_nCalibrationNbPulse = 1000;
    // This value must be calculated from test in millimeter
    final static double m_nCalibrationDistanceMM = 200;
    
    final static double m_nDistancePerPulse = m_nCalibrationDistanceMM / m_nCalibrationNbPulse;
    ...
    public static void init() {
        ...
        liftencoderLiftHeight.setDistancePerPulse(m_nDistancePerPulse);
