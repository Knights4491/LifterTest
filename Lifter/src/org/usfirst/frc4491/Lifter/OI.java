...
public class OI {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        button_HeightY.whenPressed(new cmd_liftGotoHeight(1040));
        button_HeightX = new JoystickButton(joystick_driver, 3);
        button_HeightX.whenPressed(new cmd_liftGotoHeight(720));
        button_HeightB = new JoystickButton(joystick_driver, 2);
        button_HeightB.whenPressed(new cmd_liftGotoHeight(400));
