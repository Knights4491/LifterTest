...
public class OI {
    ...
    public OI() {
        ...
        button_HeightY.whileHeld(new cmd_liftGotoHeight());
        button_HeightX = new JoystickButton(joystick_driver, 3);
        button_HeightX.whenPressed(new cmd_liftGotoHeight());
        button_HeightB = new JoystickButton(joystick_driver, 2);
        button_HeightB.whenPressed(new cmd_liftGotoHeight());
        button_HeightA = new JoystickButton(joystick_driver, 1);
        button_HeightA.whenPressed(new cmd_liftGotoHeight());

	    
        // SmartDashboard Buttons
        SmartDashboard.putData("cmd_liftCalibrateDone", new cmd_liftCalibrateDone());
        ...
        SmartDashboard.putData("cmd_liftCalibrate", new cmd_liftCalibrate());
